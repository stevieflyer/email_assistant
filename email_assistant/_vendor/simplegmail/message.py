...
from .label import Label, INBOX, SPAM, TRASH, UNREAD, STARRED, IMPORTANT
...
class Message(object):
    ...
    def untrash(self) -> None:
        ...
        try:
            ...
            assert TRASH not in res['labelIds'], \
